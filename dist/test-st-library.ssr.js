...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$6, [vue.createElementVNode("div", {
    ...
    return vue.openBlock(), vue.createElementBlock("div", {
      key: tab.id,
      class: vue.normalizeClass(_ctx.currentTabs.length == 1 ? 'label-description' : 'label-multiple-chose')
    }, [tab.id ? (vue.openBlock(), vue.createElementBlock("div", {
      key: 0,
      style: vue.normalizeStyle(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, _ctx.stylesObj.commonFontFamily), _ctx.stylesObj.fontWeightListSelected), _ctx.stylesObj.fontColor), _ctx.stylesObj.fontSize1))
    }, [vue.createVNode(_component_ChooseTab, {
      index: index,
    ...
    }, null, 8, ["index", "text", "stylesObj", "onClick"])], 4)) : vue.createCommentVNode("", true)], 2);
...
script$7.__scopeId = "data-v-34c58e19";var boxNarrationGameEnd = {
...
script$6.__scopeId = "data-v-10f37a58";var boxNarrationGameOver = {
...
script$3.__scopeId = "data-v-09d04bd1";var PreCachedImg = {
  name: "PreCachedImg",
  props: {
    preCachedImgList: {},
    editorUsage: {},
...
script$2.__scopeId = "data-v-d5aa6b62";var spinnerBox = {
  name: "Spinner"
};
var script$1 = spinnerBox;var _withScopeId = function _withScopeId(n) {
  return vue.pushScopeId("data-v-4b67f837"), n = n(), vue.popScopeId(), n;
};
...
script$1.__scopeId = "data-v-4b67f837";//returns a copy of the object
